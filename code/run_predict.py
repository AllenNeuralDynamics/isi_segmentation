...
if __name__ == "__main__":
    ...
    parser.add_argument('--sign_map_path', type=str, default='../results/sign_map.jpg', required=True, 
                        help='path to the sign map')
    parser.add_argument('--label_map_path', type=str, default='../results/label_map.png', required=True, 
                        help='path to save the label map')
    parser.add_argument('--model_path', type=str, default='../data/isi_segmentation_model/isi_segmentation_model.h5', required=True, 
