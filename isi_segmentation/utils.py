...
def extract_sign_map_from_hdf5(hdf5_path, img_path):
...
def read_img_forpred(image_path):
...
def plot_img_label(sign_map_path, label_map_path, savefig_path):
    """ Visualize the sign map and label map 
    Args:
        sign_map_path (str): path to the sign map
        label_map_path (str): path to the label map
        savefig_path (str): path to save plot
    """
